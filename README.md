...
Ниже представлена демонстрация работы системы в режиме реального времени (ввод текста транслитерации → получение перевода через WebSocket с дебаунсом в 650 мс).
